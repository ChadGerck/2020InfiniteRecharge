...
public class OI{
    ...
    public final XboxController Controller0 = new XboxController(0), Controller1 = new XboxController(1), NEScontroller3 = new XboxController(2);
    public XboxController control;
    public void Remote(int x){if(x==1){control=Controller0;}else if(x==2){control=Controller1;} else if(x==3){control=NEScontroller3;}}
